package com.wnd.myapp.lenovate.Utility;
...
import com.wnd.myapp.lenovate.ActionDialog;
import com.wnd.myapp.lenovate.ApproveOTPFragment;
import com.wnd.myapp.lenovate.CityBankFragment;
import com.wnd.myapp.lenovate.Communicator;
import com.wnd.myapp.lenovate.Config;
import com.wnd.myapp.lenovate.OtpFragment;
import com.wnd.myapp.lenovate.R;
import com.wnd.myapp.lenovate.StatusActivity;
import com.wnd.myapp.lenovate.Utility.AvenuesParams;
import com.wnd.myapp.lenovate.Utility.Constants;
import com.wnd.myapp.lenovate.Utility.RSAUtility;
import com.wnd.myapp.lenovate.Utility.ServiceHandler;
import com.wnd.myapp.lenovate.Utility.ServiceUtility;
...
public class WebViewActivity extends ActionBarActivity implements Communicator {
    ...
    String html, encVal;
    int MyDeviceAPI;
    String id = String.valueOf(ServiceUtility.randInt(0,9999));
    /**
    ...
    private class RenderView extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... arg0) {
            try {
                ...
                params.add(new BasicNameValuePair(AvenuesParams.ACCESS_CODE, "AVKJ67DK99BY18JKYB"));
                params.add(new BasicNameValuePair(AvenuesParams.ORDER_ID,id ));

                String vResponse = sh.makeServiceCall("http://www.woodndecor.in/GetRSA.php", ServiceHandler.POST, params);
                System.out.println(params);
                System.out.println(vResponse);
                if (!ServiceUtility.chkNull(vResponse).equals("")
                        && ServiceUtility.chkNull(vResponse).toString().indexOf("ERROR") == -1) {
                    StringBuffer vEncVal = new StringBuffer("");
                    vEncVal.append(ServiceUtility.addToPostParams(AvenuesParams.AMOUNT, mainIntent.getStringExtra("price")));
        ...
        protected void onPostExecute(Void result) {
                ...
                public void processHTML(String html)
                {
                    try {
                        ...
                        //Toast.makeText(getApplicationContext(), status, Toast.LENGTH_SHORT).show();
                            ...
                            intent.putExtra("tprice", mainIntent.getStringExtra("price"));
            ...
            params.append(ServiceUtility.addToPostParams(AvenuesParams.ACCESS_CODE, "AVKJ67DK99BY18JKYB")
            );
            params.append(ServiceUtility.addToPostParams(AvenuesParams.MERCHANT_ID,"70551"));
            params.append(ServiceUtility.addToPostParams(AvenuesParams.ORDER_ID,id));
            params.append(ServiceUtility.addToPostParams(AvenuesParams.REDIRECT_URL,"http://www.woodndecor.in/ccavResponseHandler.php"));
            params.append(ServiceUtility.addToPostParams(AvenuesParams.CANCEL_URL,"http://www.woodndecor.in/ccavResponseHandler.php"));
            String yahoo = "yahoo";
            params.append(ServiceUtility.addToPostParams(AvenuesParams.LANGUAGE,"EN"));
            params.append(ServiceUtility.addToPostParams(AvenuesParams.BILLING_NAME,sharedPreferences.getString("userName", null)));
            params.append(ServiceUtility.addToPostParams(AvenuesParams.BILLING_ADDRESS,sharedPreferences.getString("userAddr",null)));
            params.append(ServiceUtility.addToPostParams(AvenuesParams.BILLING_CITY,"Delhi"));
            params.append(ServiceUtility.addToPostParams(AvenuesParams.BILLING_STATE,"Delhi"));
            params.append(ServiceUtility.addToPostParams(AvenuesParams.BILLING_ZIP,sharedPreferences.getString("userPin", null)));
            params.append(ServiceUtility.addToPostParams(AvenuesParams.BILLING_COUNTRY,"India"));
            params.append(ServiceUtility.addToPostParams(AvenuesParams.BILLING_EMAIL,sharedPreferences.getString("userEmail", null)));
            params.append(ServiceUtility.addToPostParams(AvenuesParams.BILLING_TEL,sharedPreferences.getString("userNumber", null)));
            params.append(ServiceUtility.addToPostParams(AvenuesParams.DELIVERY_NAME,"Chaplin"));
            params.append(ServiceUtility.addToPostParams(AvenuesParams.DELIVERY_ADDRESS,"sfc ffd"));
            params.append(ServiceUtility.addToPostParams(AvenuesParams.DELIVERY_CITY,"Hyderabad"));
            params.append(ServiceUtility.addToPostParams(AvenuesParams.DELIVERY_STATE,"Andhra"));
            params.append(ServiceUtility.addToPostParams(AvenuesParams.DELIVERY_ZIP,"425001"));
            params.append(ServiceUtility.addToPostParams(AvenuesParams.DELIVERY_COUNTRY,"India") );
            params.append(ServiceUtility.addToPostParams(AvenuesParams.DELIVERY_TEL,"9898989898"));
            ...
            params.append(ServiceUtility.addToPostParams(AvenuesParams.DATA_ACCEPTED_AT,"Y"));
            params.append(ServiceUtility.addToPostParams(AvenuesParams.ISSUING_BANK,"Sate Bank of India"));
            params.append(ServiceUtility.addToPostParams(AvenuesParams.ENC_VAL, URLEncoder.encode(encVal)));
            Log.d("payment", params.toString());
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("price web", "wot" + getIntent().getStringExtra("price"));
